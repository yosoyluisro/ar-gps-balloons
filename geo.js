// geo.js — utilidades geográficas puras (sin dependencias).
// Convención de salida: east/north en metros. North = eje apuntando a +latitud, east = +longitud.
...
// Distancia real entre dos puntos (fórmula de haversine), en metros.
...
// Descomposición en metros locales (proyección equirectangular, exacta en <10 km):
